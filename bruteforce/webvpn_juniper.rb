...
class Webvpn_juniper
	...
	def brute_user_password
      ...
      f = File.new(@file,'r+')
			f.each do |user|
					...
					@driver.find_element(:name, "username").send_keys user.to_s
					...
					if element_present?(:name, "btnSubmit")
						#Wrong password
	...
	def element_present?(how, what)
		...
		puts e.message + "==> brute_user module webvpn juniper"
		return false
	 end
